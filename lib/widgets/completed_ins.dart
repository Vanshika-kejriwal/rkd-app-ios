...
import 'package:business_app/screens/inst_detail.dart';
...
class CompletedIns extends StatefulWidget {
  CompletedIns({super.key, this.assignlead});
  Function(bool assignExisting, Map<String, dynamic> leadinfo)? assignlead;

  @override
  State<CompletedIns> createState() => _CompletedInsState();
}

class _CompletedInsState extends State<CompletedIns> {
  ...
  Future<void> getleads() async {
    ...
    try {
      ...
      final response =
          await http.get(Uri.parse('$baseuri/api/ins_list/?type=completed&mob=$mob&ut=$ut'));
  ...
  Widget build(BuildContext context) {
    return Background(
      appbar: true,
      appbartitle: const Text("Completed Installations"),
      floatbutton: _isAdmin,
      ...
      childs: !_isDataLoaded
          ...
          : leads.isEmpty
              ? const Center(
                  child: Text("No Completed Installation"),
                )
              : Column(
                  children: [
                    Padding(
